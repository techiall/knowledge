...
import cc.techial.knowledge.domain.*;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, Node.class.getName(), jcacheConfiguration);
            createCache(cm, NodeRelationship.class.getName(), jcacheConfiguration);
            createCache(cm, Record.class.getName(), jcacheConfiguration);
            createCache(cm, Storage.class.getName(), jcacheConfiguration);
        };
    }
